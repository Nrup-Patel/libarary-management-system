...
function Book() {
  ...
  return (
    <div
      style={{ padding: "20px" }}
      className=" w-100 d-flex flex-col align-items-center justify-content-center container "
    >
      {/* <h1 className="p-2 mb-2" style={{ fontSize: '3em' }}>Library Management System</h1> */}

      <div className="w-100 gap-3 d-flex flex-col justify-content-center ">
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              <input
                ...
                value={
                  editingBook ? editingBook.total_copies : newBook.total_copies
                }
                onChange={(e) =>
                  editingBook
                    ? setEditingBook({
      ...
      <h2 style={{ fontSize: '2em' }} className="mb-2">Book List</h2>
        ...
        <tbody>
          {books && books.map((book) => (
            <tr key={book.id}>
              ...
              <td className="d-flex ">
                <button className="btn btn-primary " onClick={() => setEditingBook(book)}>Edit</button>
                {" "}
